...
{
    public class CorrosiveExplosion : ElementalProjectile
    {
        public float corrosiveMultiplier = 0.5f;
        private float elementalChance = 100f;
        private short corrosiveProjectile = ProjectileID.None;
        ...
        {
            return new Vector3(216, 253, 208);
        }
