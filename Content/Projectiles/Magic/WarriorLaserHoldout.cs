...
{
	public class WarriorLaserHoldout : ElementalProjectile
	{
		...
		private void FireBeams() {
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<WarriorLaserBeam>(), damage, knockback, Projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color drawColor = WarriorsTail.OverrideColor;
