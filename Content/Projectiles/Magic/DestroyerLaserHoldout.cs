	...
	public class DestroyerLaserHoldout : ElementalProjectile
	{
		...
		private void FireBeams() {
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<DestroyerLaserBeam>(), damage, knockback, Projectile.owner, b, uuid);
			}
        ...
        {
            return new Vector3(202, 192, 197);
        }
	}
}