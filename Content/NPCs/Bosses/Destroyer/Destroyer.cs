...
// using Vaultaria.Content.BossBars;
// using Vaultaria.Content.Items.Placeables.Furniture;
// using Vaultaria.Content.Projectiles.Magic;

// namespace Vaultaria.Content.NPCs.Bosses.Destroyer
// {
...
// 			return ModContent.NPCType<DestroyerMinion>();
// 		}
...
// 			// Add this in for bosses that have a summon item, requires corresponding code in the item (See DestroyerSummonItem.cs)
...
// 			// Custom boss bar
// 			NPC.BossBar = ModContent.GetInstance<DestroyerBossBar>();
...
// 			npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<DestroyerTrophy>(), 10));
...
// 			// notExpertRule.OnSuccess(ItemDropRule.Common(ModContent.ItemType<DestroyerMask>(), 7));
...
// 			// npcLoot.Add(ItemDropRule.BossBag(ModContent.ItemType<DestroyerBag>()));

// 			// // ItemDropRule.MasterModeCommonDrop for the relic
// 			// npcLoot.Add(ItemDropRule.MasterModeCommonDrop(ModContent.ItemType<Items.Placeable.Furniture.DestroyerRelic>()));

// 			// // ItemDropRule.MasterModeDropOnAllPlayers for the pet
// 			// npcLoot.Add(ItemDropRule.MasterModeDropOnAllPlayers(ModContent.ItemType<DestroyerPetItem>(), 4));
// 		}

// 		// public override void OnKill() {
// 		// 	// The first time this boss is killed, spawn ExampleOre into the world. This code is above SetEventFlagCleared because that will set downedDestroyer to true.
// 		// 	if (!DownedBossSystem.downedDestroyer) {
// 		// 		ModContent.GetInstance<ExampleOreSystem>().BlessWorldWithExampleOre();
// 		// 	}

// 		// 	// This sets downedDestroyer to true, and if it was false before, it initiates a lantern night
// 		// 	NPC.SetEventFlagCleared(ref DownedBossSystem.downedDestroyer, -1);
...
// 				int backGoreType = Mod.Find<ModGore>("DestroyerBody_Back").Type;
// 				int frontGoreType = Mod.Find<ModGore>("DestroyerBody_Front").Type;
...
// 				NPC minionNPC = NPC.NewNPCDirect(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<DestroyerMinion>(), NPC.whoAmI);
...
// 				DestroyerMinion minion = (DestroyerMinion)minionNPC.ModNPC;
...
// 				if (otherNPC.type == MinionType() && otherNPC.ModNPC is DestroyerMinion minion) {
...
// 					50,
// 					255, // <-- OWNER: Use 255 (or -1) for NPC-fired projectiles
// 					0,  // <-- AI[0]: Reserved for BeamID, same as original
// 					NPC.whoAmI // <-- AI[1]: Store the Spawning NPC's index (whoAmI)
// 				);   
...
//             NPC.localAI[index]++;
//             if (NPC.localAI[index] >= ticks) // Fire every 6 ticks (~0.1 sec)
//             {
//                 if (target != null)
//                 {
//                     return true;
