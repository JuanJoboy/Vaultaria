...
namespace Vaultaria.Content.Items.Accessories.Skills
{
    public class LegendaryNinja : ModSkill
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            int followThroughDamage = Utilities.DisplaySkillBonusText(30f, 0.15f);
            int followThroughSpeed = Utilities.DisplaySkillBonusText(20f, 0.1f);
            ...
            Utilities.Text(tooltips, Mod, "Tooltip6", "Bonuses increase as you progress", Utilities.VaultarianColours.Information);
            ...
            Utilities.Text(tooltips, Mod, "Tooltip10", $"+{followThroughDamage}% Generic Damage");
            Utilities.Text(tooltips, Mod, "Tooltip11", $"+{followThroughSpeed}% Movement Speed");
