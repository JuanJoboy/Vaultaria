...
namespace Vaultaria.Content.Items.Placeables.Furniture
{
	public class DestroyerTrophy : ModItem
	{
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.DestroyerTrophy>());
