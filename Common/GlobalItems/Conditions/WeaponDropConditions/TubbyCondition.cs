...
public class TubbyCondition : IItemDropRuleCondition, IProvideItemConditionDescription
{
    ...
    public string GetConditionDescription() => "Dropped from Tubbies";
