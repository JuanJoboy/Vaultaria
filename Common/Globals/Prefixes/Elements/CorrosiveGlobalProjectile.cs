...
namespace Vaultaria.Common.Globals.Prefixes.Elements
{
    public class CorrosiveGlobalProjectile : GlobalProjectile
    {
        ...
        private static int elementalPrefix = ElementalID.CorrosivePrefix;
        private static short elementalProjectile = ElementalID.CorrosiveProjectile;
        private static int elementalBuff = ElementalID.CorrosiveBuff;
